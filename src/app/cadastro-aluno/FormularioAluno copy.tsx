...
export const FormularioAluno = () => {
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center gap-4 text-gray-400 w-full">
    <label htmlFor="schoolType" className="text-black flex-shrink-0">Escola</label>
    <div className="flex flex-col md:flex-row items-start gap-4">
      <div className="flex items-center">
        <input
          type="radio"
          id="publicSchool"
          name="schoolType" // 'name' faz com que apenas um rádio seja selecionado por vez
          className="form-radio h-4 w-4 text-gray-400"
        />
        <label htmlFor="publicSchool" className="text-gray-400 ml-2">Pública</label>
      </div>
      <div className="flex items-center">
        <input
          type="radio"
          ...
          className="form-radio h-4 w-4 text-gray-400"
        />
        <label htmlFor="privateSchool" className="text-gray-400 ml-2">Privada</label>
      </div>
    </div>
  </div>

  {/* Ano de Ingresso */}
  <div className="md:flex md:flex-row flex flex-col w-full items- justify-end md:space-x-4">
    <label htmlFor="admissionYear" className="text-black mb-2 md:mb-0 flex md:items-center md:justify-center">Ingresso na escola</label>
    <input
      id="admissionYear"
      type="text"
      placeholder="aaaa"
...
<div className="flex flex-col items-start gap-4 text-gray-400 w-full pt-7 mb-2 md:mb-7">
  <label htmlFor="schoolType" className="text-black flex-shrink-0">Nível de escolaridade atual:</label>
  <div className="flex flex-col md:flex-row items-start gap-4">
    <div className="flex items-center">
      <input
        type="radio"
        ...
        className="form-radio h-4 w-4 text-gray-400"
      />
      <label htmlFor="fundamental" className="text-gray-400 ml-2">Ensino Fundamental</label>
    </div>
    <div className="flex items-center">
      <input
        type="radio"
        ...
        className="form-radio h-4 w-4 text-gray-400"
      />
      <label htmlFor="medio" className="text-gray-400 ml-2">Ensino Médio</label>
    </div>
    <div className="flex items-center">
      <input
        type="radio"
        ...
        className="form-radio h-4 w-4 text-gray-400"
      />
      <label htmlFor="tecnico" className="text-gray-400 ml-2">Ensino Técnico</label>
    </div>
  </div>
</div>
...
{/* Curso atual */}
<div className='flex flex-col md:flex-row items-center gap-4 w-full md:mb-7 mb-2 text-gray-400'>
  <label className='text-black flex-shrink-0'>Curso atual</label>
  <select
    className="flex-grow w-full py-2 px-3 rounded-lg bg-gray-300 border border-gray-200 outline-none focus:outline-none focus:ring-2 focus:ring-gray-500"
    ...
    <div className="p-4 sm:p-8 lg:p-10 max-w-4xl mx-auto bg-white rounded-lg shadow-lg my-10">
      ...
      <form id="multi-step-form" className='border border-gray-200 rounded-lg md:p-8 p-4 mt-10 relative'>
        ...
        <button className="flex items-center bg-gray-200 rounded-md border border-gray-200">
          <div
            className="flex items-center justify-center rounded-l-md w-10 h-10 bg-gradient-to-b from-amber-400 to-amber-600">
            <FaCheck />
          </div>
      ...
      <div className="flex md:justify-end mt-4 w-full">
        <button
          type="button"
          className="bg-gradient-to-t from-green-500 to-green-800 text-white px-6 py-1 rounded md:w-auto w-full"
